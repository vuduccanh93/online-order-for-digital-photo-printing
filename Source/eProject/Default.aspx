...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <span lang="EN-GB" 
            ...
            style="font-family: &quot;Verdana&quot;,&quot;sans-serif&quot;; mso-ansi-language: EN-GB" 
            title="Home Page">
    “MyImage” is a group of people who wants to develop an online site were the user 
    can upload his or her photographs and can order them for printing. </span>
    <span style="font-family: &quot;Verdana&quot;,&quot;sans-serif&quot;">A customer 
    ...
    choose the size of the prints. The application will calculate the price after 
    downloading the price information from the database for the different print 
    sizes and show it to the user. The user will enter his/her credit card/other 
    payment option (or choose any other mode of payment) and shipping information if 
    he/she wants to go ahead with the order. If the credit card information is found 
    correct, the photos are uploaded to the server and a purchase order is created 
    in the database.<o:p></o:p></span></p>
</asp:Content>
